...
public class RetrieveEmailsUsingIMAP {
    ...
    public void getEmails(String protocol, String host, String port, String userName, String password) throws IOException, GeneralSecurityException {
    ...
    public String getConnectedStatus(String protocol, String host, String port, String userName, String password) throws GeneralSecurityException {
        Properties properties = getServerProperties(protocol, host, port);
        Session session = Session.getDefaultInstance(properties);
        String isconnected="";
        try {
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        ...
        tmu.getEmails("imap", "imap.gmail.com", "993", "javabootcampecology@gmail.com", "Javabootcamp2019");
